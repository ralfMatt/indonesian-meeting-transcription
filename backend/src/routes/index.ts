...
// Initialize WebSocket service (will be injected)
let wsService: WebSocketService;

export const initializeRoutes = (websocketService: WebSocketService): Router => {
  wsService = websocketService;
  const audioController = new AudioController(wsService);
